      ...
      <div id="contact" className="min-h-screen w-full bg-white">
        <div className="pt-10 pb-4">
          <div className="container mx-auto px-4 text-center">
            <span className="inline-block px-4 py-2 rounded-full bg-[#f0fffd] text-[#01bdb2] font-semibold shadow-sm animate-fade-in">Bog'lanish</span>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="space-y-6">
              {/* Video Placeholder */}
              <div className="bg-gray-100 rounded-xl overflow-hidden shadow-lg aspect-video flex items-center justify-center cursor-pointer hover:bg-gray-200 transition-colors relative">
                <video src={vid} autoPlay loop muted className="w-full h-full object-cover"></video>
                {/* Play button overlay */}
                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 opacity-0 hover:opacity-100 transition-opacity" onClick={openVideoModal}>
