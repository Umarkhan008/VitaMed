...
const BlogPreview = ({ initialData }) => {
    const [posts, setPosts] = useState(initialData || [])
    const [loading, setLoading] = useState(!initialData)

    React.useEffect(() => {
        if (initialData) {
            setPosts(initialData.slice(0, 3))
            setLoading(false)
            return
        }
                    ...
                    {posts.map((post) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="mt-4 inline-flex items-center gap-2 text-teal-600 font-semibold text-sm hover:text-teal-700">
                                    Batafsil
