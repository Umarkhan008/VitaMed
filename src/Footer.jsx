                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                        ...
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a href="https://www.instagram.com/lor_otajon/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full bg-teal-600 text-white flex items-center justify-center transition-all duration-300 hover:bg-teal-500 hover:-translate-y-0.5">
